...
/**
 * The DmcTypeConcinnityModuleREFSTATIC provides static access to functions used to manage values of type ConcinnityModuleREF
...
public class DmcTypeConcinnityModuleREFSTATIC {
    ...
    public static DmcTypeConcinnityModuleREFSTATIC instance;
    static DmcTypeConcinnityModuleREFSV typeHelper;
    
    static {
        instance = new DmcTypeConcinnityModuleREFSTATIC();
    }
    ...
    public ConcinnityModuleREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public ConcinnityModuleREF cloneValue(ConcinnityModuleREF value) throws DmcValueException {
