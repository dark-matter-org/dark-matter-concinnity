...
public class DmcTypeConceptREFMV extends DmcTypeConceptREF implements Serializable {
    
    private final static Iterator<ConceptREF> emptyList = (new ArrayList<ConceptREF>()).iterator();
    
    protected ArrayList<ConceptREF> value;
    
    public DmcTypeConceptREFMV(){
    
    }
    
    public DmcTypeConceptREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeConceptREFMV getNew(){
        return(new DmcTypeConceptREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ConceptREF> cloneIt(){
        synchronized(this){
            DmcTypeConceptREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(ConceptREF val: value)
                try {
                    rc.add(val);
    ...
    public ConceptREF add(Object v) throws DmcValueException {
        synchronized(this){
            ConceptREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<ConceptREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ConceptREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ConceptREF> clone = new ArrayList<ConceptREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2452)
    public ArrayList<ConceptREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ConceptREF>());
            else 
                return(new ArrayList<ConceptREF>(value));
        }
    }
    ...
    public ConceptREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ConceptREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ConceptREF>(getAttributeInfo().indexSize);
