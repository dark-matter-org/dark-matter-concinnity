...
public class DmcTypeConcinnityDefinitionREFMV extends DmcTypeConcinnityDefinitionREF implements Serializable {
    
    private final static Iterator<ConcinnityDefinitionREF> emptyList = (new ArrayList<ConcinnityDefinitionREF>()).iterator();
    
    protected ArrayList<ConcinnityDefinitionREF> value;
    
    public DmcTypeConcinnityDefinitionREFMV(){
    
    }
    
    public DmcTypeConcinnityDefinitionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeConcinnityDefinitionREFMV getNew(){
        return(new DmcTypeConcinnityDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public ConcinnityDefinitionREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ConcinnityDefinitionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ConcinnityDefinitionREF del(Object v){
        synchronized(this){
            ...
            ConcinnityDefinitionREF key = null;
    ...
    public Iterator<ConcinnityDefinitionREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ConcinnityDefinitionREF> clone = new ArrayList<ConcinnityDefinitionREF>(value);
    ...
    public ArrayList<ConcinnityDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ConcinnityDefinitionREF>());
            else 
                return(new ArrayList<ConcinnityDefinitionREF>(value));
        }
    }
    ...
    public ConcinnityDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<ConcinnityDefinitionREF>(getAttributeInfo().indexSize);
