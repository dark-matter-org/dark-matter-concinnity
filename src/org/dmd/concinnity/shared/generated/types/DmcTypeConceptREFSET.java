...
public class DmcTypeConceptREFSET extends DmcTypeConceptREF implements Serializable {
    
     private final static Iterator<ConceptREF> emptyList =  (new HashSet<ConceptREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<ConceptREF>();
        else
            value = new TreeSet<ConceptREF>();
    }
    
    @Override
    public DmcTypeConceptREFSET getNew(){
        return(new DmcTypeConceptREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ConceptREF> cloneIt(){
        synchronized(this){
            DmcTypeConceptREFSET rc = getNew();
    ...
    public Iterator<ConceptREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<ConceptREF>(value)).iterator() );
            else
                return( (new TreeSet<ConceptREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<ConceptREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<ConceptREF>(value));
                else
                    return(new TreeSet<ConceptREF>(value));
            }
        }
